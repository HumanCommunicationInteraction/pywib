...
from .segmentation import (extract_traces_by_session, extract_mouse_click_traces_by_ession, 
                           extract_mouse_click_traces_by_session_with_intial_pause, extract_traces_by_session_parallel)
...
__all__ = [
    ...
    'extract_traces_by_session_parallel'
    'video_from_trace'
]